							 ...
							 <?php   
								...
								if (empty($_GET['g'])) {
								 ...
								 $banksoal = fetch($koneksi,'banksoal',['id_bank'=>$idbank]);
									$map = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM mata_pelajaran where kode='$banksoal[nama]' "));
                                ...
                                <div class="card widget widget-payment-request">
									...
									<label class="bold">Mata Pelajaran</label>
									  ...
									  <div class="input-group mb-1">
                                       ...
                                       <?php $level = mysqli_query($koneksi, "select kelas from kelas where level='$kelasmu'"); ?>
