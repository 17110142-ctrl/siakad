...
$id_bank = $_GET['m'];	
$id_kelas = $_GET['k'];
$mapelQ = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM banksoal JOIN mata_pelajaran ON mata_pelajaran.kode=banksoal.nama where id_bank='$id_bank' "));
...
$dompdf->render();
$dompdf->stream("Anbuso Kelas ".$id_kelas.".pdf", array("Attachment" => false));
exit(0);
?>