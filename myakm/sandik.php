...
if ($pg == enkripsi('banksoal') & $ac =='pg') :
	$sidebar = 'full';
elseif ($pg == enkripsi('banksoal') & $ac =='multi') :
	$sidebar = 'full';
elseif ($pg == enkripsi('banksoal') & $ac =='bs') :
	$sidebar = 'full';
elseif ($pg == enkripsi('banksoal') & $ac =='urut') :
	$sidebar = 'full';
elseif ($pg == enkripsi('editsoal1')) :
	$sidebar = 'full';	
elseif ($pg == enkripsi('editsoal2')) :
	$sidebar = 'full';		
elseif ($pg == enkripsi('editsoal3')) :
	$sidebar = 'full';		
elseif ($pg == enkripsi('editsoal4')) :
	$sidebar = 'full';		
elseif ($pg == enkripsi('editsoal5')) :
	$sidebar = 'full';		
elseif ($pg == enkripsi('jadwal')) :
	$sidebar = 'full';		
...
?>
<?php if($user['level'] !='admin' AND $user['level'] !='guru'):
 echo
'<meta content="0; url=../proktor/" http-equiv="refresh">';
endif;
 ?>
