      ...
      <div class="col-md-12">
                <div class="card">
				  <div class="card-header">
                   <h5 class="card-title">DATA NILAI </small></h5> 
                            ...
                            <tbody>
                                ...
                                <?php while ($data = mysqli_fetch_array($siswaQ)) : ?>
                                    ...
                                    $bank = fetch($koneksi,'banksoal',['id_bank'=>$data['id_bank']]);
									 $mapel = fetch($koneksi,'mata_pelajaran',['kode'=>$bank['nama']]);
                                    ?>
                                    <tr>
                                        <td><?= $no ?></td>                                       
   ...
   ?>
			...
			<div class="col-md-8">
                      <div class="card">
						...
						<?php if($kelas !=''): ?>
						 <a href="siswa/prosesexcel.php?idb=<?= $bank['id_bank'] ?>&sesi=<?= $_GET['sesi'] ?>&kls=<?= $kelas ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Download Jawaban"><i class="material-icons">download</i>JAWABAN</a>		  
						<a href="siswa/nilai_excel.php?idb=<?= $bank['id_bank'] ?>&sesi=<?= $_GET['sesi'] ?>&kls=<?= $kelas ?>" class="btn btn-sm btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Download Nilai"><i class="material-icons">download</i>NILAI</a>			
						<?php endif; ?>
						</div>
							</div>
                 <div class="card-body">
				...
				?>
                 ...
                 <div class="col-md-4">
                     <div class="card widget widget-payment-request">
                         <div class="card-header">
                        <h5 class="card-title">NILAI <?= strtoupper($bank['kode']); ?> | Tingkat <?= $bank['level'] ?></h5>
							</div>
                 <div class="card-body">
				 ...
				 <div class="widget-payment-request-info m-t-md">
                     <label class="bold">KELAS</label>
						...
						<select class="form-select kelas">						
                                <?php $level = mysqli_query($koneksi, "select kelas from kelas where level='$bank[level]'"); ?>
   ...
   ?>
            <div class="row">
                          <div class="col">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">KOREKSI JAWABAN ESAI <?= strtoupper($bank['kode']); ?></h5>
