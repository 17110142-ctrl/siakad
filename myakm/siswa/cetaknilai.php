...
$mapel = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT banksoal.*, mata_pelajaran.nama_mapel FROM banksoal INNER JOIN mata_pelajaran ON banksoal.nama=mata_pelajaran.kode WHERE id_bank='$id_bank'"));
