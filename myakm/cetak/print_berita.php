...
$idujian = @$_GET['id'];
$sqlx = mysqli_query($koneksi, "SELECT * FROM berita a LEFT JOIN banksoal b ON a.id_bank=b.id_bank LEFT JOIN mata_pelajaran c ON b.nama=c.kode WHERE a.id_berita='$idujian'");
	...
	<table border='0' width='100%'>
		<tr>
			...
			<td rowspan='4' style="width:'120'; text-align:center">
				<img src='../../images/<?= $setting['logokanan'] ?>' width='80px'>
			</td>
