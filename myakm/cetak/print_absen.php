...
echo "<link rel='stylesheet' href='$homeurl/vendor/css/cetak.min.css'>";
...
$namamapel =    mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM mata_pelajaran WHERE kode='$mapelx[nama]'"));
...
<?php for ($i = 1; $i <= $n; $i++) : ?>
    ...
    <?php if ($i == $n) : ?>
        <div class='page'>
            <table width='100%'>
                <tr>
                    <td width='100'><img src='../../images/<?= $setting['logokanan'] ?>' width='80'></td>
            ...
            <table class='detail'>
                <tr>
                    ...
                    <td>ID SERVER</td>
                    <td>:</td>
                    <td><span style='width:150px;'>&nbsp;<?= $setting['id_server'] ?></span></td>
                </tr>
                <tr>
                    <td>RUANG</td>
                    <td>:</td>
