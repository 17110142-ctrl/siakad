                    ...
                    <table id="datatable1" class='table table-hover table-bordered edis2'>
                        ...
                        <tbody>
                            ...
                            <?php while ($berita = mysqli_fetch_array($beritaQ)) : ?>
                                <?php
                                $mapel = mysqli_fetch_array(mysqli_query($koneksi, "select * from banksoal a left join mata_pelajaran b ON a.nama=b.kode where a.id_bank='$berita[id_bank]'"));
                                $no++
                                ?>
                                <tr>
                                    <td><?= $no ?></td>
									...
									<div class="form-group">												
                                           <label class="bold">Sesi</label>
                                            <select class="form-select" id="bcsesi" name="sesi" required>
                                                ...
                                                <option>Ruang</option>
                                                <?php $ru = mysqli_query($koneksi, "select * from ruang"); ?>
