					       ...
					       <div class="col-md-4">
                                ...
                                <div class="card widget widget-payment-request">
                                    <div class="card-header">
										...
										<a href="?pg=<?= enkripsi('rfid') ?>&ac=<?= enkripsi('siswa') ?>" class="btn btn-success"><i class="material-icons">crisis_alert</i>Siswa</a>
										<a href="?pg=<?= enkripsi('rfid') ?>&ac=<?= enkripsi('pegawai') ?>" class="btn btn-primary"><i class="material-icons">crisis_alert</i>Pegawai</a>
                                    </div>
                                    <div class="card-body">
					       ...
					       <div class="col-md-4">
                                ...
                                <div class="card widget widget-payment-request">
                                    <div class="card-header">
										...
										<a href="?pg=<?= enkripsi('rfid') ?>" class="btn btn-primary kanan"><i class="material-icons">crisis_alert</i>Cek Data</a>
                                    </div>
                                    <div class="card-body">
                                        <div class="widget-payment-request-container">
                                            <div class="widget-payment-request-author">
		      ...
		      <?php elseif ($ac == enkripsi('pegawai')) : ?>			
					<div class="row">
                          <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">REGISTRASI RFID PEGAWAI</h5>
