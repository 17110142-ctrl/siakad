                    ...
                    <table style="text-align:center; width:100%">
                        <tr>
							...
							<?php if($setting['mesin']=='2'){ ?>
							  &nbsp;&nbsp;&nbsp;&nbsp;
							  <img src="../../temp/<?= $r['nis'] ?>.png" style="margin-top:-100px;width:100px;height:100px;">
							 </p> 
                            
							<?php }else{ ?>
							<?php if($r['foto'] !=''): ?>
                              <center><img src="../../images/fotosiswa/<?= $r['foto'] ?>" style="margin-top:-300px;width:100px;height:120px;"></center></p> 
                            <?php else: ?>
