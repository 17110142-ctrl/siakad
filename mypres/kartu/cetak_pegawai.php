...
$jpegawai = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM users where level<>'admin'"));
?>
 <?php if ($ac == '') : ?>
  <div class="row">
     <div class="col-md-8">
        <div class="card">
			<div class="card-header">
				...
				<div class="pull-right">
				 <a href="?pg=<?= enkripsi('cetakpegawai') ?>&ac=<?= enkripsi('update') ?>" class='btn btn-primary' data-bs-toggle="tooltip" data-bs-placement="top" title="Update Pegawai"><i class="material-icons">upload</i>Update</a>
				</div>		
				 </div>
		          <div class="card-body"> 
                 <div class="row">
				  ...
				  <div class="row mb-1">
					...
					<input type='file' name='depan' class='form-control' />
						...
						<div class="col-sm-4">
                      <?php if($mesin['depan'] !=''): ?>						
                       <img src="<?= $homeurl ?>/images/kartu/<?= $mesin['depan'] ?>" height='100px' />                      
						<?php endif; ?> 
						 </div>				
					</div><p>
					...
					<?php if($mesin['belakang'] !=''): ?>						
                       <img src="<?= $homeurl ?>/images/kartu/<?= $mesin['belakang'] ?>" height='100px' />   
					<?php endif; ?> 					   
						 </div>				
					</div><p>
					<div class="col-sm-12">		
...
<script>
   $('#formpengaturan').submit(function(e) {
		...
		<div class="card-body"> 
                  ...
                  <form action="kartu/potrait_pegawai.php" target="_blank" method="POST" class="form-horizontal form-label-left">
                    <?php else: ?>
					<form action="kartu/landscape_pegawai.php" target="_blank" method="POST" class="form-horizontal form-label-left">
                    <?php endif; ?>	
		...
		<div class="card-body"> 
                   <?php if($mesin['model']=='Potrait'): ?>
                  <form action="kartu/potrait_pegawai2.php" target="_blank" method="POST" class="form-horizontal form-label-left">
                    <?php else: ?>
					<form action="kartu/landscape_pegawai2.php" target="_blank" method="POST" class="form-horizontal form-label-left">
                    <?php endif; ?>	
							<div class="item form-group">
						<label class="bold">Dari ID</label>
							<div class="col-md-12">
...
?>   
     ...
     <div class="col-md-8">  
			 <div class="card">
			<div class="card-header">
				<h5 class="card-title">UPDATE DATA PEGAWAI</h5>
				
					<a href="kartu/proses_pegawai.php" class="btn btn-sm btn-link pull-right" data-toggle="tooltip" data-placement="top" title="Download Format"><i class="fa fa-download"></i> Download Format</a>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                ...
                                                <span class="widget-stats-amount"><?= $jpegawai; ?> PD</span>
                                                <span class="widget-stats-info">dari <?= $jpegawai ?> PD</span><p>
												</div>
                                            </div>
                                        </div>
                                    </div>
