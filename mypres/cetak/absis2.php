                        ...
                        <div class="row">
                           <div class="col-xl-8">
                             ...
                             <div class="col-xl-4">
                                <div class="card widget widget-payment-request">
                                    <div class="card-header">
                                        <h5 class="card-title">CETAK PRESENSI EKSTRAKURIKULER</h5>
                                    </div>
                                    <div class="card-body">
									 <form id="formabsen" method="POST" action="cetak/cetakkelas2.php" target="_blank" enctype="multipart/form-data">
