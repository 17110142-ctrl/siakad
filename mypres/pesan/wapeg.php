...
?>
                           ...
                           <div class="col-xl-8">
                                <div class="card widget widget-payment-request">
                                    <div class="card-header">
                                        <h5 class="card-title">NOTIF WHATS APP PEGAWAI</h5>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%">
											...
											<?php
											$no=0;
											$query = mysqli_query($koneksi, "SELECT * FROM users WHERE level<>'admin' AND nowa<>''"); 
									 ...
									 <form id="formsiswa">
                                        <div class="widget-payment-request-container">
                                            ...
                                            <div class="widget-payment-request-actions m-t-lg d-flex">
                                                <a href="sandik_absen/prosespeg.php" class="btn btn-success flex-grow-1 m-r-xxs">Download Format</a>
					...
					$('#formsiswa').submit(function(e){
						...
						{
							type: 'POST',
							 url: 'sandik_absen/import_wapeg.php',
							data: data,
							cache: false,
							contentType: false,
							processData: false,
