  ...
  <link rel="stylesheet" type="text/css" href="<?= $homeurl ?>/style.css">
  
  <script src="<?= $homeurl ?>/jquery.min.js"></script>
  <script src="<?= $homeurl ?>/bootstrap.min.js"></script>
  <script src="<?= $homeurl ?>/face-api.js"></script>
  <style>
video {
  max-width: 100%;
  height: auto;
...
?>       
	...
	<?php if ($ac == '') : ?>
					       ...
					       <div class="col-md-4">
                                ...
                                <div class="card widget widget-payment-request">
                                    <div class="card-header">
										...
										<a href="?pg=faces&ac=siswa" class="btn btn-success"><i class="material-icons">crisis_alert</i>Register</a>
											...
											$.ajax({
											   url: 'face/tface.php?pg=hapus',
												...
												success: function(data) {
													...
													setTimeout(function() {
														window.location.replace('?pg=faces');
													}, 2000);
												}
											});
										}
     ...
     <?php 
       $sql=mysqli_query($koneksi,"SELECT * FROM siswa WHERE sts='0'");
      ...
      if($("#register").hasClass('active')){
        ...
        if(counter <= 5 && counter >= 0 ){
          ...
          iziToast.info(
			{
			title: 'Sukses!',
			message: 'Wajah berhasil di simpan',
			titleColor: '#FFFF00',
			messageColor: '#fff',
			backgroundColor: 'rgba(0, 0, 0, 0.5)',
			progressBarColor: '#FFFF00',
