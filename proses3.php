...
$exec = mysqli_query($koneksi, "UPDATE jawaban SET jawabbs='$jawab',jawaban='$jawab',bs1='$bs1',bs2='$bs2',bs3='$bs3',bs4='$bs4',bs5='$bs5' WHERE id_siswa='$id_siswa' AND id_ujian='$id_ujian' AND id_soal='$id_soal' AND jenis='$jenis'");

	}else{
		
$exec = mysqli_query($koneksi, "INSERT INTO jawaban (id_siswa,id_bank,id_soal,id_ujian,jawabbs,jawaban,jenis,bs1,bs2,bs3,bs4,bs5) VALUES ('$id_siswa','$id_bank','$id_soal','$id_ujian','$jawab','$jawab','$jenis','$bs1','$bs2','$bs3','$bs4','$bs5')");
