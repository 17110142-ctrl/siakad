...
if ($cek ==0) {
	...
	$koneksi -> close();
     ...
     echo $nama;	
        $peg = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM users WHERE idjari='$data[idjari]'"));
		...
		if($status['mode']=='1' AND $jumlah_absen==0):
            ...
            $notif_masuk_peg = $pesan3['pesan1']." ".$pesan3['pesan2']." *".$peg['nama']."* ".$pesan3['pesan3']." ".$tglabsen." ".$pesan3['pesan4']." *Keterangan Absen :* ".$ket;		   
