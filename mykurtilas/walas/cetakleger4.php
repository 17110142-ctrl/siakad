							 ...
							 <table style="margin-left: 10px;margin-right:10px"  width="100%" border='1'>
										...
										<?php																				
                                           ...
                                           <?php endwhile; ?>										
											...
											?>
											<td style="text-align: center"><?= number_format($nilai['nilai4']) ?></td>
											<?php } ?>
											   </tr>
											<?php endwhile; ?>
...
$dompdf->render();
$dompdf->stream("Leger_KI-4.pdf", array("Attachment" => false));
exit(0);
?>