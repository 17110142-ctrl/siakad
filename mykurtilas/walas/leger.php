                          ...
                          <div class="col-md-9">
                                <div class="card">
                                    <div class="card-header">
										...
										<?php if($kelas !=''): ?>
										<a href="walas/cetakleger.php?k=<?= $kelas ?>" target="_blank" class="btn btn-sm btn-primary"><i class="material-icons">print</i>CETAK KI-3</a>
										<a href="walas/cetakleger4.php?k=<?= $kelas ?>" target="_blank" class="btn btn-sm btn-success"><i class="material-icons">print</i>CETAK KI-4</a>
									...
									<div class="card-box table-responsive">
                                        <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%;font-size:12px">
                                           ...
                                           <?php endwhile; ?>										
											...
											?>
											<td style="text-align: center"><h5><span class="badge badge-success"><?= number_format($nilai['nilai3']) ?></span>  <span class="badge badge-primary"><?= number_format($nilai['nilai4']) ?></span></h5></td>
											<?php } ?>
											   </tr>
											<?php endwhile; ?>
												</tbody>
