                          ...
                          <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="bold">DESKRIPSI RAPOR <span class="badge badge-primary">PENGETAHUAN</span>
										<?php if($kelas<>''){ ?>
									...
									<div class="card-box table-responsive">
                                        <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%;font-size:12px">
											...
											$jnil = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM deskripsi where level='$data[level]' and mapel='$mapel' and guru='$guru' and ki='KI3'  and smt='$semester'"));
											$no++;
											   ?>
                                                <tr>
                                                    <td><?= $no; ?></td>
													...
													<?php else : ?>
													<a href="?pg=<?= enkripsi('deskrip3') ?>&ac=<?= enkripsi('edit') ?>&id=<?= enkripsi($des['id']) ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Input Nilai"><i class="material-icons">edit</i> </a>																								
													<?php endif; ?>
													</td>
                                                </tr>
												<?php endwhile; ?>
                                ...
                                <div class="card widget widget-payment-request">
                                    <div class="card-header">                                    
										<h5 class="card-title">INPUT DESKRIPSI KI-3</h5>									
									</div>
                                    <div class="card-body">
							...
							<div class="col-md-12">
								...
								<select name="guru" class='form-select guru' required='true' style="width: 100%" >
										...
										$('#cari').click(function() {
											...
											var mapel = $('.mapel').val();
											 var guru = $('.guru').val();
											location.replace("?pg=<?= enkripsi('deskrip3') ?>&level=" + level + "&kelas=" + kelas + "&mapel=" + mapel + "&guru=" + guru);
										}); 
									</script>
                                            </div>
			 ...
			 ?>
	                ...
	                <div class="row">
                          <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="bold">DESKRIPSI RAPOR KI-3<br> <span class="badge badge-secondary"><?= $siswa['nama'] ?></span> | <span class="badge badge-primary"><?= $nilai['nilai3'] ?></span></h5>
                                        ...
                                        <table id="datatable1" class="table table-bordered edis2" style="width:100%;font-size:12px">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
													<?php
											$query = mysqli_query($koneksi, "SELECT * FROM deskripsi WHERE mapel='$mapel' and level='$level' and smt='$semester' and ki='KI3' and guru='$guru'"); 	
											  while ($data = mysqli_fetch_array($query)) :
										  ...
										  &nbsp;<?= $data['deskripsi'] ?>
													...
													<?php endwhile; ?>
													    ...
													    <td>														
														<?php
											$query2 = mysqli_query($koneksi, "SELECT * FROM deskripsi WHERE mapel='$mapel' and level='$level' and smt='$semester' and ki='KI3' and guru='$guru' ORDER BY id DESC"); 	
							...
							<script>
								$('#formmapel3').submit(function(e){
									...
									width: "30%"
										...
										setTimeout(function()
										{
										   window.location.replace('?pg=<?= enkripsi(deskrip3) ?>&mapel=<?= $mapel ?>&kelas=<?= $kelas ?>&guru=<?= $guru ?>');
										}, 2000);
										 } else {
										 iziToast.warning(
										{
