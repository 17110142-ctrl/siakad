                           ...
                           <div class="col-xl-12">
                                <div class="card widget widget-payment-request">
                                    <div class="card-header">
                                        <h5 class="card-title">
										PRESTASI SISWA KELAS <?= $selectedKelas !== '' ? htmlspecialchars($selectedKelas) : '-' ?>
										</h5>
                                    </div>
...
<?php if ($isKurikulumTask && !empty($kelasList)) : ?>
    <form method="get" class="row g-2 mb-3">
        <input type="hidden" name="pg" value="prestasi">
        <div class="col-md-6 col-lg-4">
            <label for="kelasFilterPrestasi" class="form-label">Pilih Kelas</label>
            <select id="kelasFilterPrestasi" name="kelas" class="form-select" onchange="this.form.submit()">
...
<?php if ($selectedKelas !== '') : ?>
                                        ...
                                        <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%">
											...
											$query = mysqli_query($koneksi, "SELECT * FROM prestasi WHERE kelas='$kelasEsc'"); 
