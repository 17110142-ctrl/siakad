       ...
       <div class='col-md-12'>
          <div class="card">
			<div class="card-header">
				<h5 class="card-title kanan">PENGATURAN SEKOLAH</h5>
...
<div class="card-body">            
	...
	<input type="text" name='desa' class='form-control' value="<?= $setting['desa'] ?>"  required='true' >
        ...
        <label  class="col-sm-1 col-form-label">NIP/NIY</label>
        <div class="col-sm-5">
		<input type='text' name='no_guru' value="<?= $setting['no_guru'] ?>" class='form-control' required='true' />
          </div>
										  </div>
		<div class="row mb-1">
        ...
        <div class="col-sm-10">
			...
			<div class="row mb-1">
            <label class="col-sm-2 col-form-label">Tanggal Pengumuman Kelulusan</label>
            <div class="col-sm-4">    
                <input type="date" class="form-control" name="tgl" value="<?= date('Y-m-d', strtotime($setting['tgl_pengumuman'])) ?>"/>
            </div>
            <label class="col-sm-2 col-form-label">Jam Pengumuman Kelulusan</label>
            <div class="col-sm-4">
                <input type="time" class="form-control" name="jam" value="<?= date('H:i', strtotime($setting['tgl_pengumuman'])) ?>" />
            </div>
            </div>
            <div class="row mb-1">
						   ...
						   <div class="col-sm-5">
							...
							<div class="col-sm-4">
							   <input type='file' name='logo' class='form-control' />
                                      ...
                                      <label  class="col-sm-1 col-form-label"></label>	
										<div class="col-sm-4">									  
                                                <img src="<?= $homeurl ?>/images/<?= $setting['logo'] ?>" height='50px' />
                                            
						                </div>				
									 </div><p>
							<div class="row mb-1">
							<label  class="col-sm-2 col-form-label">Logo Kanan</label>
							<div class="col-sm-4">
							   <input type='file' name='logokanan' class='form-control' />
                                            </div>
                                      <label  class="col-sm-1 col-form-label"></label>	
										<div class="col-sm-4">									  
                                                <img src="<?= $homeurl ?>/images/<?= $setting['logokanan'] ?>" height='50px' />
							...
							<div class="col-sm-4">
							   <input type='file' name='stempel' class='form-control' />
                                      ...
                                      <label  class="col-sm-1 col-form-label"></label>	
										<div class="col-sm-4">									  
                                                <img src="<?= $homeurl ?>/images/<?= $setting['stempel'] ?>" height='50px' />
							...
							<div class="col-sm-4">
							   <input type='file' name='ttd' class='form-control' />
                                      ...
                                      <label  class="col-sm-1 col-form-label"></label>	
										<div class="col-sm-4">									  
                                                <img src="<?= $homeurl ?>/images/<?= $setting['ttd'] ?>" height='50px' />
