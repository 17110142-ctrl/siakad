...
$tabel = "*";
$backup_file = 'backup/sandik_' . time() . '.sql';
$mybackup = backup_tables($host, $user, $pass, $debe, $tabel);
$exec = mysqli_query($koneksi,"INSERT INTO backup(file)VALUES('$backup_file')");
// save to file
...
<div class="alert alert-custom" role="alert">
	...
	<a href="pengaturan/download.php?filename=<?= $backup_file ?>" ><button class="btn btn-outline-primary"> Download</button></a>
