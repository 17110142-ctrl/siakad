    ...
    <table width="100%">
		 ...
		 <table class='it-grid it-cetak' width='100%'>       
              <tr height='40px'>
                    ...
                    <th width="15%" style="text-align:center;">Tangggal</th>
					 <th colspan="2" style="text-align:center;">Jam Absen</th>
					
                    <th width="10%"style="text-align:center;">Kehadiran</th>
					<th width="15%" style="text-align:center;">Keterangan</th>
                    <th width="20%" style="text-align:center;">Paraf</th>
                   </tr>
			...
			<table width='100%'>
					...
					<td width='50px'></td>
						...
						<td width="5%"></td>
						<td>
							<?= $setting['kecamatan'] ?>, <?php echo $i-1; ?> <?= $bulane['ket'] ?> <?= date('Y') ?><br/>
					...
					<br/>
							...
							NIP. <?= $setting['nip'] ?>
						<img style="z-index: 920;position:relative;margin-top:-55px;margin-left:-30px;opacity:0.7" class="img" src="../../images/<?= $setting['ttd'] ?>" width="160px">
							
						
						</td>
						 <img style="z-index: 920;position:relative;margin-top:-90px;margin-left:440px;opacity:0.7" class="img" src="../../images/<?= $setting['stempel'] ?>" width="150px">
