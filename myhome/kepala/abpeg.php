                           ...
                           <div class="col-xl-8">
                                                     ...
                                                     <td><?= $hadir; ?></td>
													   <td><?= $izin; ?></td>
													     <td><?= $sakit; ?></td>
														   <td><?= $alpha; ?></td>
                                                    <td>
													<a href="?pg=detail&ids=<?= $data['id_user'] ?>" class="btn btn-sm btn-primary">Detail</a>
													</td>
                                                </tr>
												<?php endwhile; ?>
                                                </table>
                             ...
                             <div class="col-xl-4">
                                <div class="card widget widget-payment-request">
                                    ...
                                    <div class="card-body">
									 <form id="formabsen" method="POST" action="kepala/cetakpeg.php" target="_blank" enctype="multipart/form-data">
