   ...
   <br>
		 ...
		 <table class='it-grid it-cetak' width='100%'>       
              <tr>
                ...
                <th width="1%">A</th>
                  ...
                  <?php
			$query = mysqli_query($koneksi,"select * from users WHERE level<>'admin'  GROUP BY id_user");
             $no = 0;
	...
	<table width='100%'>
					...
					<td width='50px'></td>
						...
						<td width="5%"></td>
						<td>
						<?= ucwords(strtolower($setting['kecamatan'])); ?>, <?php echo $i-1; ?> <?= $bulane['ket'] ?> <?= date('Y') ?><br/>
					...
					<br/>
						...
						<img style="z-index: 920;position:relative;margin-top:-55px;margin-left:-30px;opacity:0.7" class="img" src="../../images/<?= $setting['ttd'] ?>" width="160px">
						 ...
						 <img style="z-index: 920;position:relative;margin-top:-90px;margin-left:650px;opacity:0.7" class="img" src="../../images/<?= $setting['stempel'] ?>" width="150px">
