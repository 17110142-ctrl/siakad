                          ...
                          <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">CETAK NILAI HARIAN</h5>
											   ...
											   <tr>
												 ...
												 <td><?= $harix['hari'] ?></td>
                                                   <td><h5><span class="badge badge-dark"><?= $data['tingkat'] ?></span> <span class="badge badge-primary"> <?= $data['kelas'] ?></span></h5></td>
													...
													<td>
													<?php if($jumdes<>0): ?>
													<a href="cetak/ctnilai.php?j=<?= enkripsi($data['id_jadwal']) ?>" target="_blank" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Cetak PH"><i class="material-icons">print</i> </a>
													<?php else : ?>
