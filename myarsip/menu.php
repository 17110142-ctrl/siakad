				...
				<li class="sidebar-title">
				 ...
				 <li><a href="."><i class="material-icons-two-tone">home</i>Beranda</a></li>
				   <li><a href="../myhome"><i class="material-icons-two-tone">apps</i>Home</a></li>
				    <!-- ✅ Tambahan menu List Arsip -->
                    <li><a href="?pg=<?= enkripsi('arsip') ?>"><i class="material-icons-two-tone">folder</i>List Arsip</a></li>
					<li>
                        ...
                        <ul class="sub-menu">
						<li><a href="?pg=settingsrtkl">Pengaturan Surat Keluar</a></li>
