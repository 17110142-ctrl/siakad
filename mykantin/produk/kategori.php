...
?>           
									...
									<div class="card-box table-responsive">
                                        <table id="datatable1" class="table table-bordered table-hover" style="width:100%;font-size:12px">
											...
											$no++;
											  ...
											  <a href="?pg=kategori&ac=edit&idk=<?= $data['kategori_id'] ?>"> <button class='btn btn-sm btn-success' data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="material-icons">edit</i></button></a>
    ...
    $('#formedit').submit(function(e){
		...
		$.ajax(
		{
			...
			setTimeout(function()
				{
				window.location.replace('?pg=kategori');
						}, 2000);
