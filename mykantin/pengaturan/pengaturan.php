       ...
       <div class='col-md-12'>
          <div class="card">
			<div class="card-header">
				<h5 class="card-title">Pengaturan Instansi</h5>
	...
	<input type="text" name='desa' class='form-control' value="<?= $setting['desa'] ?>"  required='true' >
        ...
        <div class="col-sm-10">
			<input type='number' name='nowa' value="<?= $setting['nowa'] ?>" class='form-control' />
									...
									<div class="row mb-1">
                           <label  class="col-sm-2 col-form-label">Waktu Server</label>
						   <div class="col-sm-10">
							...
							<div class="col-sm-4">
							   <input type='file' name='logo' class='form-control' />
                                   ...
                                   <div class="col-sm-12">		
                                      			<br>					 
                                                <button type='submit' name='submit1' id="blockui-2"class='btn btn-primary pull-right' > Simpan</button>
