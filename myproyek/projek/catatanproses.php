             ...
             <div class="card-body">
					...
					<div class="col-md-4">
                               ...
                               <div class="col-md-12">
								...
								<select name="kelas" class='form-select kelas' required='true' style="width: 100%">
								    
                                       <?php
										if($user['level']=='admin'):
											$query = mysqli_query($koneksi, "SELECT * FROM kelas WHERE kurikulum='2'");
											echo "<option value=''>Pilih Rombel</option>";											
											else:
											$query = mysqli_query($koneksi, "SELECT * FROM kelas WHERE kelas='$user[walas]' AND kuri='2'"); 	
										  endif;
										while ($tkt = mysqli_fetch_array($query)) {										
										echo "<option value='$tkt[kelas]'>$tkt[kelas]</option>";
													}
													?>						
									 </select>
							     </div>	
  ...
  <div class="col-md-10">
      <div class="card">
         ...
         <h5 class="card-title">CATATAN PROSES <?= $kelas ?></h5>
             ...
             <div class="card-body">
						<form id="formtujuan" class="form-horizontal" action=''  class="form-horizontal" >
								<input type="hidden" name="proyek" value="<?= $id ?>" >	
						    <div class="row mb-3">
							<label  class="col-sm-3 control-label">Kelas</label>
							<div class="col-sm-9">
							<select name='kelas' class='form-select' style="width:30%;" >
							...
							<div class="col-sm-9">
							<select name='fase' class='form-select' style="width:30%;" >
							...
							(SELECT * 
							 ...
							 WHERE siswa.id_siswa = nilai_proses.idsiswa AND nilai_proses.proyek_ke='$proyek[ke]')"); ?>
								 ...
								 <div class="row mb-3">
							<label  class="col-sm-3 control-label">Catatan Proses</label>
							<div class="col-sm-9">
