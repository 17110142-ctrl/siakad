...
?>           
                   ...
                   <div class="row">
									...
									<div class="card-box table-responsive">
                                        <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%;font-size:12px">
                                            ...
                                            <tbody>
                                                <?php
											$no=0;
											$query = mysqli_query($koneksi, "SELECT * FROM sinkron where id between 7 and 8"); 
					     ...
					     <input type="hidden" class="form-control" name="tokenapi" id="tokenapi" value="<?= $setting['token_api'] ?>" >
							<?php if($konek=="TERHUBUNG KE SERVER"): ?>
							<button type="submit" class="btn btn-primary flex-grow-1 m-l-xxs" id="blockui-1"><i class="material-icons">auto_mode</i>SINKRON</button>
                             <?php endif; ?>  								 
								 </div>
										</form>
