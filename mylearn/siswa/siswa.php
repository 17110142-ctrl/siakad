...
$jpes = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM siswa WHERE ruang<>''"));
?>           
			<?php if ($ac == '') : ?>
     ...
     <div class="col-md-8">  
			...
			<div class="card-header">
				<h5 class="card-title">Update Peserta Ujian</h5>
					...
					<a href="siswa/prosessiswa.php" class="btn btn-sm btn-link pull-right" data-toggle="tooltip" data-placement="top" title="Download Format"><i class="material-icons">download</i> Download Format</a>
    ...
    $('#formsiswa').submit(function(e){
		...
		$.ajax(
		{
			...
			success: function(data){   		
					...
					setTimeout(function()
						{
						window.location.replace('?pg=peserta');
						}, 2000);
